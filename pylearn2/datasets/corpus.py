...
class Corpus(dataset.Dataset):
    def __init__(self, window_size, batch_size=100, num_input_words=None,
...
class PennTreebank(Corpus):
    """
    Loads the Penn Treebank corpus.
    """
    def __init__(self, which_set, *args, **kwargs):
        ...
        del npz_data
        super(PennTreebank, self).__init__(*args, **kwargs)
...
class Europarl(Corpus):
    def __init__(self, which_set, *args, **kwargs):
        ...
        super(Europarl, self).__init__(*args, **kwargs)
